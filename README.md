...
Disclaimer:
All the javascript, css, html are not written by me, coming from Coursera owned by Dr-Chuck.
I wrote all the python files from spidering the url to ranking it, which I learned from Coursera.
